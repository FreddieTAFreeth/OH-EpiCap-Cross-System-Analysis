...
Evaluating epidemiological systems under the OneHealth criterion, following the work of the OH-EpiCap Tool. This repository contains the code and data that generates the figures seen in the paper under review *Implementation of One Health surveillance systems, opportunities and challenges: Lessons learned from the OH-EpiCap application* by Henok Ayalew Tegegne<sup>1</sup>, **Frederick T. A. Freeth**<sup>2</sup> , Carlijn Bogaardt<sup>2</sup> , Emma Taylor<sup>2</sup>, Johana Reinhardt<sup>3</sup> , Lucie Collineau<sup>1</sup> , Joaquin M Prada<sup>2</sup>, and Viviane Hénaux<sup>1</sup>.
